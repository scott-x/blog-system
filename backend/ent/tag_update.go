...
func (_u *TagUpdate) SetBackground(v string) *TagUpdate {
	_u.mutation.SetBackground(v)
	return _u
}

// SetNillableBackground sets the "background" field if the given value is not nil.
func (_u *TagUpdate) SetNillableBackground(v *string) *TagUpdate {
	if v != nil {
		_u.SetBackground(*v)
	}
	return _u
...
func (_u *TagUpdate) ClearBackground() *TagUpdate {
...
func (_u *TagUpdate) sqlSave(ctx context.Context) (_node int, err error) {
	...
	if value, ok := _u.mutation.Background(); ok {
		_spec.SetField(tag.FieldBackground, field.TypeString, value)
	}
	if _u.mutation.BackgroundCleared() {
		_spec.ClearField(tag.FieldBackground, field.TypeString)
	}
...
// SetBackground sets the "background" field.
func (_u *TagUpdateOne) SetBackground(v string) *TagUpdateOne {
	_u.mutation.SetBackground(v)
	return _u
}

// SetNillableBackground sets the "background" field if the given value is not nil.
func (_u *TagUpdateOne) SetNillableBackground(v *string) *TagUpdateOne {
	if v != nil {
		_u.SetBackground(*v)
	}
	return _u
...
// ClearBackground clears the value of the "background" field.
func (_u *TagUpdateOne) ClearBackground() *TagUpdateOne {
	_u.mutation.ClearBackground()
	return _u
}
